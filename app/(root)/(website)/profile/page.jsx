                    ...
                    {({ getRootProps, getInputProps }) => (
                        <div {...getRootProps()}>
                          ...
                          <Avatar className='w-28 h-28 relative group border border-gray-100'>
                            ...
                            <div className='absolute z-50 w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-center items-center border-violet-500 border-2 rounded-full group-hover:flex hidden cursor-pointer bg-black/20'><FaCamera color='#7c3aed'/></div>
                          </Avatar>
                        </div>
                    )}
                  </Dropzone>
