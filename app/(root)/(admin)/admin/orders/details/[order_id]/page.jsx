      ...
      <div className='  border'>
        {!orderData ?
          <div className='flex justify-center items-center py-32'>
            <h4 className='text-red-500 text-3xl font-semibold'>Order Not Found</h4>
          </div>
          :
          <div>
                ...
                <tbody>
                  {orderData && orderData?.products?.map((product) => (
                        ...
                        <div className='flex items-center gap-5 '>
                          ...
                          <div>
                            <h4 className='text-lg line-clamp-1'>
                              <Link href={WEBSITE_ORDER_DETAILS(product?.productId?.slug)}>{product?.productId?.name}</Link>
                            </h4>
                    ...
                    text-center'>
                      ...
                      <td className='md:table-cell flex justify-between md:p-3 px-3 pb-2
                    text-center'>
                        <span className='md:hidden font-medium'>Quentity</span>
              ...
              <div className='grid md:grid-cols-2 grid-cols-1 gap-10 border mt-10'>
                  ...
                  <div>
                    <table className='w-full'>
                      <tbody>
                        ...
                        <tr>
                          <td className='font-medium py-2 line-clamp-1'>E-mail</td>
                ...
                <div className="p-5 bg-gray-50 dark:bg-card">
                  ...
                  <div className='pt-3'>
                    ...
                    <ButtonLoading type='button' onClick={handleOrderStatus} text='Save Status' className='mt-5 cursor-pointer' loading={updatingStatus} />
                  </div>
                </div>
