        ...
        <div>
            ...
            <Card className='py-0 rounded shadow-sm'>
                ...
                <CardContent className="pb-5">
                    {selectedMedia.length > 0
                        ...
                        <div className='py-2 px-3 bg-violet-200 mb-2 rounded flex justify-between items-center'>
                            ...
                            <div className='flex gap-2'>
                                {deleteType === 'SD' ?
                                    <Button variant="destructive" onClick={() => handleDelete(selectedMedia, deleteType)} className="cursor-pointer">Move Into Trash</Button>
                                    :
                                    <>
                                        <Button className="bg-green-500 hover:bg-green-600" onClick={() => handleDelete(selectedMedia, "RSD")}>Restore</Button>
                                        <Button variant="destructive" onClick={() => handleDelete(selectedMedia, deleteType)}>Delete Parmentely</Button>
                                    </>
                                }
                            </div>
                        </div>
                    ...
                    {status === 'pending'
                        ...
                        status === 'error'
                            ...
                            <>
                                ...
                                {data.pages.flatMap(page => page.mediaData.map(media => media._id)).length === 0 && <div className=' text-red-600 font-bold text-2xl'>No Media</div>}
                    ...
                    {hasNextPage &&
                    <ButtonLoading type="button" className="cursor-pointer font-bold " loading={isFetching} onClick={()=> fetchNextPage()} text="Load More"/>
