        ...
        <CardContent className="pb-5">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <div className="mb-5">
                <Image src={mediaData?.data?.secure_url || imgPlaceholder} alt={mediaData?.atl || 'Image'} width={150} height={150} />
              </div>
              <div className="mb-5">
                <FormField
              ...
              <div className='mb-3'>
                <ButtonLoading loading={loading} type="submit" text="Upload Media" className={" cursor-pointer"} />
              </div>
