...
const AddProduct = () => {
    ...
    const [selectedMedia, setsetselectedMedia] = useState([])
    ...
    const onSubmit = async (value) => {
        ...
        try {
            ...
            const { data: response } = await axios.post('/api/product-variant/create', value)
            if (!response.success) {
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className=''>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Select options={productOption} selected={field.value} setSelected={field.onChange} isMulti={false} />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                            ...
                            <div className='md:col-span-2 border border-dashed rounded p-5 text-center'>
                                <MediaModal open={open} setopen={setopen} selectedMedia={selectedMedia} setsetselectedMedia={setsetselectedMedia} isMultiple={true} />
