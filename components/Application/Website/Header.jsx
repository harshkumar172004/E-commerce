'use client'
import { USER_DASHBOARD, WEBSITE_ABOUT, WEBSITE_HOME, WEBSITE_LOGIN, WEBSITE_SHOP } from '@/routes/WebsiteRoute'
        ...
        <div className='bg-white border-b lg:px-32 px-4'>
            <div className='flex justify-between items-center lg:py-5 py-3'>
                ...
                <div className='flex justify-between gap-20'>
                    <nav className={`lg:relative lg:top-0 lg:w-auto lg:h-auto lg:left-0 lg:p-0 bg-white fixed z-50 top-0 w-full h-screen transition-all ${isMobileMenu ? 'left-0' : '-left-full'} `}>
                        ...
                        <ul className='lg:flex justify-between items-center gap-10 px-3'>
                            ...
                            <li className='text-gray-600 hover:text-primary hover:font-semibold'>
                                <Link href={WEBSITE_ABOUT} className='block py-2'>About</Link>
                            </li>
                            <li className='text-gray-600 hover:text-primary hover:font-semibold'>
                            ...
                            <li className='text-gray-600 hover:text-primary hover:font-semibold'>
                                <Link href={`${WEBSITE_SHOP}?category=polo`} className='block py-2'>Polo</Link>
                            </li>
                        </ul>
                    </nav>
